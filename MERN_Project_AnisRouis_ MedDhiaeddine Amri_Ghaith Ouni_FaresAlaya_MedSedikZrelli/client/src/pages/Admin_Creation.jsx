...
const AdminCreation = () => {
    ...
    const submitHandler = (e) => {
        ...
        axios.post(`http://localhost:8000/api/auctions/admin/new`, tempAuction)
            .then((res) => {
    ...
    return (
        <div className="flex items-center justify-center h-screen">
            <div className="rounded-lg shadow-lg overflow-hidden mx-4 md:mx-10">
                <div className="mt-10 text-center font-bold">Create Auction</div>
                <div className="mt-3 text-center text-4xl font-bold">Create Auction Details</div>
                <div className="p-8">
                    <form onSubmit={submitHandler} className='container'>
                        ...
                        <div className="mb-6 flex flex-col items-center">
                            <button type="submit" className="text-white bg-red-500 hover:bg-red-600 focus:outline-none focus:ring-4 focus:ring-red-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-red-400 dark:hover:bg-red-500 dark:focus:ring-red-900">Create Auction</button>
                        </div>
